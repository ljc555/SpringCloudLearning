package com.ljc555.springcloud.zipkinprovider.controller;
...
public class ZipkinUserController {
    ...
    public UserData getUser(@PathVariable final String uid) {
        ...
        user.setServer("zipkinprovider");
        return user;
    }

    @GetMapping(value="/provder")
    public UserData provder(@PathVariable final String uid) {
        return restTemplate.getForObject("http://localhost:8989/user/01",UserData.class);
    }
}
