package com.ljh.springcloud.aopserver.aop;
...
public class ApiAspect {
    ...
    @Pointcut("execution(* com.ljh.springcloud.aopserver.controller.HelloController.*(..))")// 定义切点表达式
    @Order(2)
    public void controllerPoint() {
    }

    @Pointcut("@annotation(com.ljh.springcloud.aopserver.annotation.RedisCache)")
    ...
    public void before(JoinPoint joinPoint) {
        ...
        logger.info("响应方法: " + joinPoint.getSignature().getDeclaringTypeName() + "." + joinPoint
    ...
    @After("within(com.ljh.springcloud.aopserver.controller.*Controller)")
    public void after() {
    ...
    @AfterThrowing("within(com.ljh.springcloud.aopserver.controller.*Controller)")
